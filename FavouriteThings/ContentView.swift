    ...
    var body: some View {
        ScrollView {
            ...
            VStack { Text("My Favourite Things")
                ...
                Text("    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Gravida rutrum quisque non tellus orci ac auctor. Suscipit tellus mauris a diam maecenas sed enim ut. Tortor consequat id porta nibh venenatis. Egestas diam in arcu cursus euismod quis. Id aliquet risus feugiat in ante metus dictum at tempor. Sit amet volutpat consequat mauris nunc. My favourite colour is blue and purple. I love pasta especially lasagna. ")
                .foregroundColor(Color.gray)
                .padding(.all)
                 Image("Sailing1")
                    .resizable()
